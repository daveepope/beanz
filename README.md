...
beanz is a small companion for developers, researchers, students or anyone using an AI harness such as Claude or Cursor who want to keep an eye on cognitive debt they are accumulating. Beanz is small, a bit annoying, and that's the point. Beanz nudges you when you've vibed a little too hard, added too much collagen to the dish, and shipped something that works but that you (or your team) don't really understand. Working code, or a polished document isn't the same as understood code, or acquiring knowledge, and beanz watches your agent sessions and scores that gap so you know when to stop, commit, or break the work into something smaller.
